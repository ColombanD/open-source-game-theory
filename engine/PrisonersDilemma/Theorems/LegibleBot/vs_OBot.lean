...
theorem outcome_LegibleBot_vs_OBot :
  ...
  refine ⟨max kA (max kB kC), fun k hk fuel => outcome_at_of_ex ?_ ?_ fuel⟩
  ...
  · refine outcome_total_of_plays (play_search_const_total _ _ _ _ _ 3) ?_
    exact play_ite_total (fuel := 4) rfl (eval_sim_opp_bot_total (play_total_mono (play_search_const_total _ _ _ _ _ 0) 3 (by omega)))
      (eval_ite_total (fuel := 3) (eval_sim_opp_bot_total (play_search_const_total _ _ _ _ _ 0)) (eval_const_total _ _ _ _) (eval_const_total _ _ _ _)) (eval_const_total _ _ _ _)
end PD.Theorems
