...
\textbf{Extensions after the core setup:}
\begin{itemize}
...
\textbf{Possible exploratory direction:}
\begin{itemize}
...
As stated in the main lines, the idea will be to manually provide the outcome of playing pairs of agents against each other.

For example, we will rigorously prove that \[
\texttt{outcome}(\texttt{CINTDB}, \texttt{CIMCIC}) = (\texttt{D}, \texttt{D})
\]
