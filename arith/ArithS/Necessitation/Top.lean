...
/-! ### The step-cost constants are linear (`stepK`, `stepKM`, `costK`) -/

section costLin

lemma hornCost_le (N E B : V) : hornCost N E 0 8 8 B ≤ 684 * (N + B * E + B + E + 1) := by
  unfold hornCost
  exact le_iff_exists_add.mpr ⟨683 * N + 450 * (B * E) + 683 * B + 676 * E, by ring⟩

lemma introCost_le (N E B : V) : introCost N E 0 8 8 B ≤ 693 * (N + B * E + B + E + 1) := by
  unfold introCost
  exact le_iff_exists_add.mpr ⟨692 * N + 423 * (B * E) + 692 * B + 685 * E, by ring⟩

lemma stepK_le (N E B : V) : stepK N E B ≤ 1387 * (N + B * E + B + E + 1) := by
  unfold stepK
  have h1 := hornCost_le N E B
  have h2 := introCost_le N E B
  have h3 : 6 * (B * E) + 4 ≤ 10 * (N + B * E + B + E + 1) :=
    le_iff_exists_add.mpr ⟨10 * N + 4 * (B * E) + 10 * B + 10 * E + 6, by ring⟩
  calc hornCost N E 0 8 8 B + (6 * (B * E) + 4) + introCost N E 0 8 8 B
      ≤ 684 * (N + B * E + B + E + 1) + 10 * (N + B * E + B + E + 1) + 693 * (N + B * E + B + E + 1) :=
        add_le_add (add_le_add h1 h3) h2
    _ = 1387 * (N + B * E + B + E + 1) := by ring

lemma stepKM_le (N E B : V) : stepKM N E B ((8 : ℕ) : V) ≤ 1387 * (N + B * E + B + E + 1) := by
  have : stepKM N E B ((8 : ℕ) : V) = stepK N E B := by
    unfold stepKM stepK; simp only [Nat.cast_ofNat]
  rw [this]; exact stepK_le N E B

lemma costK_le (N E B Q D : V) :
    costK N E B ((8 : ℕ) : V) Q D ≤ 1387 * (N + B * E + B + E + 1) + 27 * (Q * E) + 2 * E + 7 * Q + D + 42 := by
  unfold costK
  exact add_le_add (add_le_add (add_le_add (add_le_add (add_le_add (stepKM_le N E B) le_rfl) le_rfl) le_rfl) le_rfl) le_rfl
...
/-- The constant of `topBound_pb` (read off the graded derivation; see `topDc`). -/
def topBc (cN cB cE ck cχ cS cF cL cD : ℕ) : ℕ :=
  (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * (cE * 1)) + ck * (cE * 1) + 15 * (cF + cL * (4 * (cB * cE)) + cχ * 1 + ck * 1) + 240 * (4 * (cB * cE) + 2 * (4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * (cE * 1)) + ck * (cE * 1)) + cB * cE)) + 1 + 8 * (cL * (1387 * (cN + cB * cE + cB + cE + 1) + 36 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE))))) + 8 * (cχ * 1 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cN + cE + 1 * 1)) + ck * 1 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * (cE * 1)) + cN + cE + 1 * 1) + 15 * (1387 * (cN + cB * cE + cB + cE + 1) + 27 * ((4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * (cE * 1)) + ck * (cE * 1)) + cB * cE) * cE) + 2 * cE + 7 * (4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * (cE * 1)) + ck * (cE * 1)) + cB * cE) + cD + 42 + 35 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * (cE * 1)) + ck * (cE * 1) + 15 * (cF + cL * (4 * (cB * cE)) + cχ * 1 + ck * 1) + 240 * (4 * (cB * cE) + 2 * (4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * (cE * 1)) + ck * (cE * 1)) + cB * cE)) + (cF + cL * (4 * (cB * cE)) + cχ * 1 + ck * 1 + 15 * (4 * (cB * cE) + 2 * (4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * (cE * 1)) + ck * (cE * 1)) + cB * cE))))))

/-- **`topBound` is cubic** in `G` given the graded bounds on its inputs: `N, B, Ck, Cχ` standard,
`E, S₀, F₀, d + 1 ≤ c·G`, `Lr, lk + 1 ≤ c·u`, `D ≤ cD·G³`. -/
theorem topBound_pb {cN cB cE ck cχ cS cF cL cD : ℕ} {N B E Ck Cχ lk d S₀ F₀ Lr D : V}
    (hN : PB G u cN N 0 0) (hB : PB G u cB B 0 0) (hE : PB G u cE E 1 0) (hCk : PB G u ck Ck 0 0)
    ...
    PB G u (topBc cN cB cE ck cχ cS cF cL cD) (topBound N B E Ck Cχ lk d S₀ F₀ Lr D) 3 0 := by
  unfold topBc
  have h1 : PB G u 1 (1 : V) 0 0 := PB.one'
  have h2 : PB G u 2 (2 : V) 0 0 := PB.two
  have h4 : PB G u 4 (4 : V) 0 0 := PB.natCast 4 (by norm_num)
  have h7 : PB G u 7 (7 : V) 0 0 := PB.seven
  have h15 : PB G u 15 (15 : V) 0 0 := PB.natCast 15 (by norm_num)
  have h27 : PB G u 27 (27 : V) 0 0 := PB.natCast 27 (by norm_num)
  have h36 : PB G u 36 (36 : V) 0 0 := PB.natCast 36 (by norm_num)
  have h42 : PB G u 42 (42 : V) 0 0 := PB.natCast 42 (by norm_num)
  have h240 : PB G u 240 (15 * 15 + 15 : V) 0 0 := PB.natCast 240 (by norm_num)
  have h35 : PB G u 35 (3 * ((8 : ℕ) : V) + 11) 0 0 := PB.natCast 35 (by norm_num)
  have h1387 : PB G u 1387 (1387 : V) 0 0 := PB.natCast 1387 (by norm_num)
  have hBE := (hB.mul hE).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)
  have h4BE := (h4.mul hBE).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)
  have hLin := ((((((hN).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)).add hBE).add ((hB).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num))).add hE).add ((h1).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)
  have hStepK := PB.of_le (stepK_le N E B) ((h1387.mul hLin).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num))
  have hLF := (hL.mul hF).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num)
  have hLL := ((hL.mul hL).add ((hL).mono hc (e' := 0) (f' := 2) (by norm_num) (by norm_num))).mono hc (e' := 0) (f' := 2) (by norm_num) (by norm_num)
  have hS1 := ((((hS).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num)).add ((hLF).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))).add ((hLL.mul h4BE).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num)
  have hF1 := (((hF).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num)).add ((hL.mul h4BE).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num))).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num)
  have hS2 := (hS1.add ((hCχ.mul (hE.mul hu1)).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num)
  have hF2 := (hF1.add ((hCχ.mul hu1).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num))).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num)
  have hS2r := PB.reduce hc ((hS2).mono hc (e' := 1) (f' := 3) (by norm_num) (by norm_num))
  have hS3 := (hS2r.add ((hCk.mul (hE.mul hd1)).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num)
  have hF3 := ((PB.uG hc hF2).add ((hCk.mul hd1).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num)
  have hQ := ((h4.mul hS3).add ((hBE).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num)
  have hGr := (((h4BE).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num)).add (h2.mul hQ)).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num)
  have hLeaf := ((((hS3.add (h15.mul hF3)).add (h240.mul hGr)).add ((h1).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num)))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)
  have hRoot := (PB.reduce hc ((hL.mul (((hStepK).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num)).add (h36.mul hS1))).mono hc (e' := 1) (f' := 3) (by norm_num) (by norm_num))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)
  have hu2 : PB G u (1 * 1) ((lk + 1) ^ 2) 0 2 := PB.of_le (le_of_eq (pow_two _)) (hu1.mul hu1)
  have hd2 : PB G u (1 * 1) ((d + 1) ^ 2) 2 0 := PB.of_le (le_of_eq (pow_two _)) (hd1.mul hd1)
  have hPin := (PB.reduce hc (((hCχ.mul hu1).mul ((((hS1.add ((hN).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))).add ((hE).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))).add ((hu2).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))))).mono hc (e' := 1) (f' := 3) (by norm_num) (by norm_num))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)
  have hVer := ((hCk.mul hd1).mul ((((hS2r.add ((hN).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).add ((hE).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).add hd2))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)
  have hCostK := PB.of_le (costK_le N E B (4 * (S₀ + Lr * F₀ + (Lr * Lr + Lr) * (4 * (B * E)) + Cχ * (E * (lk + 1)) + Ck * (E * (d + 1))) + B * E) D) (((((((((h1387.mul hLin).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)).add ((h27.mul (hQ.mul hE)).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).add ((h2.mul hE).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).add ((h7.mul hQ).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).add hD).add ((h42).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))
  have hInner := (((hS3.add (h15.mul hF3)).add (h240.mul hGr)).add (hF3.add (h15.mul hGr))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)
  have hClose := (h15.mul (hCostK.add ((h35.mul hInner).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)
  unfold topBound topQ topS3 topF3 topS2 topF2 topS1 topF1 growK
...
/-! ## 10. The assembly with the coarse kits -/

section assemblyCoarse

lemma hornCost9_le (N E B : V) : hornCost N E 0 9 9 B ≤ 940 * (N + B * E + B + E + 1) := by
  unfold hornCost
  exact le_iff_exists_add.mpr ⟨939 * N + 650 * (B * E) + 939 * B + 931 * E, by ring⟩

lemma introCost9_le (N E B : V) : introCost N E 0 9 9 B ≤ 949 * (N + B * E + B + E + 1) := by
  unfold introCost
  exact le_iff_exists_add.mpr ⟨948 * N + 620 * (B * E) + 948 * B + 940 * E, by ring⟩

lemma stepKM9_le (N E B : V) : stepKM N E B ((9 : ℕ) : V) ≤ 1899 * (N + B * E + B + E + 1) := by
  unfold stepKM
  simp only [Nat.cast_ofNat]
  have h1 := hornCost9_le N E B
  have h2 := introCost9_le N E B
  have h3 : 6 * (B * E) + 4 ≤ 10 * (N + B * E + B + E + 1) :=
    le_iff_exists_add.mpr ⟨10 * N + 4 * (B * E) + 10 * B + 10 * E + 6, by ring⟩
  calc hornCost N E 0 9 9 B + (6 * (B * E) + 4) + introCost N E 0 9 9 B
      ≤ 940 * (N + B * E + B + E + 1) + 10 * (N + B * E + B + E + 1) + 949 * (N + B * E + B + E + 1) :=
        add_le_add (add_le_add h1 h3) h2
    _ = 1899 * (N + B * E + B + E + 1) := by ring

lemma costK9_le (N E B Q D : V) :
    costK N E B ((9 : ℕ) : V) Q D ≤ 1899 * (N + B * E + B + E + 1) + 27 * (Q * E) + 2 * E + 7 * Q + D + 42 := by
  unfold costK
  exact add_le_add (add_le_add (add_le_add (add_le_add (add_le_add (stepKM9_le N E B) le_rfl) le_rfl) le_rfl) le_rfl) le_rfl

/-- `ctxBoundG` with the context replaced by bounds on its `setLen`/`fvOccS`. -/
noncomputable def ctxB (G S F L : V) : V := S + L * F + (L * L + L) * G

lemma ctxBoundG_le_ctxB {G Γ L S F : V} (hS : setLen LAct Γ ≤ S) (hF : fvOccS LAct Γ ≤ F) :
    ctxBoundG G Γ L ≤ ctxB G S F L := by
  unfold ctxBoundG ctxB
  exact add_le_add (add_le_add hS (mul_le_mul_of_nonneg_left hF zero_le)) le_rfl

noncomputable def topS2' (B E Cχ lk S₀ F₀ Lr : V) : V :=
  ctxB (growK B E (kitQ Cχ B E)) (topS1 B E S₀ F₀ Lr) (topF1 B E F₀ Lr) (Cχ * (lk + 1))
noncomputable def topF2' (B E Cχ lk F₀ Lr : V) : V := topF1 B E F₀ Lr + Cχ * (lk + 1) * growK B E (kitQ Cχ B E)
noncomputable def topS3' (B E Ck Cχ lk d S₀ F₀ Lr : V) : V :=
  ctxB (growK B E (kitQ Ck B E)) (topS2' B E Cχ lk S₀ F₀ Lr) (topF2' B E Cχ lk F₀ Lr) (Ck * (d + 1))
noncomputable def topF3' (B E Ck Cχ lk d F₀ Lr : V) : V :=
  topF2' B E Cχ lk F₀ Lr + Ck * (d + 1) * growK B E (kitQ Ck B E)
noncomputable def topQ' (B E Ck Cχ lk d S₀ F₀ Lr : V) : V := 4 * topS3' B E Ck Cχ lk d S₀ F₀ Lr + B * E

/-- **The explicit bound, coarse shape**: leaf + root + pin kit + verify kit + closing block. -/
noncomputable def topBound' (N B E Ck Cχ lk d S₀ F₀ Lr D : V) : V :=
  (topS3' B E Ck Cχ lk d S₀ F₀ Lr + 15 * topF3' B E Ck Cχ lk d F₀ Lr +
      (15 * 15 + 15) * growK B E (topQ' B E Ck Cχ lk d S₀ F₀ Lr) + 1) +
  Lr * (stepK N E B + 36 * topS1 B E S₀ F₀ Lr) +
  Cχ * (lk + 1) * (costK N E B ((9 : ℕ) : V) (kitQ Cχ B E) (kitD Cχ lk) +
    38 * (ctxB (growK B E (kitQ Cχ B E)) (topS1 B E S₀ F₀ Lr) (topF1 B E F₀ Lr) (Cχ * (lk + 1)) +
      (topF1 B E F₀ Lr + Cχ * (lk + 1) * growK B E (kitQ Cχ B E)))) +
  Ck * (d + 1) * (costK N E B ((9 : ℕ) : V) (kitQ Ck B E) (kitD Ck d) +
    38 * (ctxB (growK B E (kitQ Ck B E)) (topS2' B E Cχ lk S₀ F₀ Lr) (topF2' B E Cχ lk F₀ Lr) (Ck * (d + 1)) +
      (topF2' B E Cχ lk F₀ Lr + Ck * (d + 1) * growK B E (kitQ Ck B E)))) +
  15 * (costK N E B ((8 : ℕ) : V) (topQ' B E Ck Cχ lk d S₀ F₀ Lr) D +
    (3 * ((8 : ℕ) : V) + 11) * ((topS3' B E Ck Cχ lk d S₀ F₀ Lr + 15 * topF3' B E Ck Cχ lk d F₀ Lr +
      (15 * 15 + 15) * growK B E (topQ' B E Ck Cχ lk d S₀ F₀ Lr)) +
...
theorem top_main' (χ : Semisentence LAct 1) {tbl N B W tblN N' B' tblL N₂ B₂ tblM N₃ B₃ : V} {Ck Cχ : ℕ}
    ...
    (hPl : formulaLen LAct (Plength : V) ≤ B) (hPeq : formulaLen LAct (Peq : V) ≤ B) (hPle : formulaLen LAct (Ple : V) ≤ B)
    (htblN : NumTableOK tblN N' B') (htblL : LenTableOK tblL N₂ B₂) (htblM : MulTableOK tblM N₃ B₃)
    (hkit : VerifyKit' tbl N B W tblN Ck) (hpin : PinKit' χ tbl N B Cχ)
    {k ρ : V} (hρ : Proof TAct ρ (instB (⌜χ⌝ : V) k)) (hlen : dlen TAct ρ ≤ gBudget k)
    {L : V} (hL : VerifyGraph W tblN ρ L) {E : V} (hE : Etop χ k (dlen TAct ρ) Ck Cχ ≤ E) :
    ∃ e Lr : V, LenDerivable TAct e (instB (⌜Box_g χ⌝ : V) k) ∧
      Lr + 4 ≤ 12 * formulaLen LAct (instB (⌜χ⌝ : V) k) + 13 ∧
  ...
  have hS3 : setLen LAct Γ₃ ≤ topS3' B E Ck Cχ ‖k‖ (dlen TAct ρ) (setLen LAct Γ₀) (fvOccS LAct Γ₀) (len (rootSteps x)) :=
    le_trans vS (ctxBoundG_le_ctxB hS2 hF2)
  have hF3 : fvOccS LAct Γ₃ ≤ topF3' B E Ck Cχ ‖k‖ (dlen TAct ρ) (fvOccS LAct Γ₀) (len (rootSteps x)) :=
    ...
    have h_ver : costSum N E Γ₂ L ≤ (Ck : V) * (dlen TAct ρ + 1) *
        (costK N E B ((9 : ℕ) : V) (kitQ (Ck : V) B E) (kitD (Ck : V) (dlen TAct ρ)) +
          38 * (ctxB (growK B E (kitQ (Ck : V) B E)) (topS2' B E Cχ ‖k‖ (setLen LAct Γ₀) (fvOccS LAct Γ₀) (len (rootSteps x)))
            (topF2' B E Cχ ‖k‖ (fvOccS LAct Γ₀) (len (rootSteps x))) ((Ck : V) * (dlen TAct ρ + 1)) +
            (topF2' B E Cχ ‖k‖ (fvOccS LAct Γ₀) (len (rootSteps x)) + (Ck : V) * (dlen TAct ρ + 1) * growK B E (kitQ (Ck : V) B E)))) :=
...
/-! ## 11. The degree-4 bound and `BoundedInnerNec 4` -/

section quartic

lemma le_pow4 (a : V) : a ≤ a ^ 4 := by
  rcases Arithmetic.zero_le a with rfl | pos
  · simp
  · have := le_cube a
    calc a ≤ a * a * a := this
      _ ≤ a * a * a * a := le_mul_of_one_le_right zero_le (pos_iff_one_le.mp pos)
      _ = a ^ 4 := by ring

lemma sq_le_pow4 (a : V) : a * a ≤ a ^ 4 := by
  rcases Arithmetic.zero_le a with rfl | pos
  · simp
  · have h1 : (1 : V) ≤ a := pos_iff_one_le.mp pos
    calc a * a ≤ a * a * a := le_mul_of_one_le_right zero_le h1
      _ ≤ a * a * a * a := le_mul_of_one_le_right zero_le h1
      _ = a ^ 4 := by ring

lemma cube_le_pow4 (a : V) : a * a * a ≤ a ^ 4 := by
  rcases Arithmetic.zero_le a with rfl | pos
  · simp
  · calc a * a * a ≤ a * a * a * a := le_mul_of_one_le_right zero_le (pos_iff_one_le.mp pos)
      _ = a ^ 4 := by ring

lemma succ_quart_le (a : V) : (a + 1) ^ 4 ≤ 16 * (a ^ 4 + 1) := by
  calc (a + 1) ^ 4 = a ^ 4 + 4 * (a * a * a) + 6 * (a * a) + 4 * a + 1 := by ring
    _ ≤ a ^ 4 + 4 * a ^ 4 + 6 * a ^ 4 + 4 * a ^ 4 + 1 :=
        add_le_add (add_le_add (add_le_add (add_le_add le_rfl (mul_le_mul' le_rfl (cube_le_pow4 a)))
          (mul_le_mul' le_rfl (sq_le_pow4 a))) (mul_le_mul' le_rfl (le_pow4 a))) le_rfl
    _ ≤ 16 * (a ^ 4 + 1) := le_iff_exists_add.mpr ⟨a ^ 4 + 15, by ring⟩

/-- `q ≤ (16c) · (g⁴ + 1)` from a degree-4 graded bound. -/
lemma PB.final_quart {g u : V} (hc : PBCtx (g + 1) u) {c : ℕ} {q : V} (h : PB (g + 1) u c q 4 0) :
    q ≤ ((16 * c : ℕ) : V) * (g ^ 4 + 1) := by
  unfold PB at h
  rw [pow_zero, mul_one] at h
  calc q ≤ (c : V) * (g + 1) ^ 4 := h
    _ ≤ (c : V) * (16 * (g ^ 4 + 1)) := mul_le_mul' le_rfl (succ_quart_le g)
    _ = ((16 * c : ℕ) : V) * (g ^ 4 + 1) := by push_cast; ring
...
def topBc' (cN cB cE ck cχ cS cF cL cD : ℕ) : ℕ :=
  (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * 1 * (cF + cL * (4 * (cB * cE))) + (cχ * 1 * (cχ * 1) + cχ * 1) * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + ck * 1 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + (ck * 1 * (ck * 1) + ck * 1) * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1)))) + 15 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1)))) + ck * 1 * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1))))) + 240 * (4 * (cB * cE) + 2 * (4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * 1 * (cF + cL * (4 * (cB * cE))) + (cχ * 1 * (cχ * 1) + cχ * 1) * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + ck * 1 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + (ck * 1 * (ck * 1) + ck * 1) * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1))))) + cB * cE)) + 1 + 8 * (cL * (1387 * (cN + cB * cE + cB + cE + 1) + 36 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE))))) + 8 * (cχ * 1 * (1899 * (cN + cB * cE + cB + cE + 1) + 27 * (cχ * ((cB + 1) * (cE + 1)) * cE) + 2 * cE + 7 * (cχ * ((cB + 1) * (cE + 1))) + 8 * (cχ * (1 * 1 * 1)) + 42 + 38 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * 1 * (cF + cL * (4 * (cB * cE))) + (cχ * 1 * (cχ * 1) + cχ * 1) * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1)))) + (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1)))))))) + ck * 1 * (1899 * (cN + cB * cE + cB + cE + 1) + 27 * (ck * ((cB + 1) * (cE + 1)) * cE) + 2 * cE + 7 * (ck * ((cB + 1) * (cE + 1))) + ck * (1 * 1 * 1) + 42 + 38 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * 1 * (cF + cL * (4 * (cB * cE))) + (cχ * 1 * (cχ * 1) + cχ * 1) * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + ck * 1 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + (ck * 1 * (ck * 1) + ck * 1) * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1)))) + (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1)))) + ck * 1 * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1))))))) + 15 * (1387 * (cN + cB * cE + cB + cE + 1) + 27 * ((4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * 1 * (cF + cL * (4 * (cB * cE))) + (cχ * 1 * (cχ * 1) + cχ * 1) * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + ck * 1 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + (ck * 1 * (ck * 1) + ck * 1) * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1))))) + cB * cE) * cE) + 2 * cE + 7 * (4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * 1 * (cF + cL * (4 * (cB * cE))) + (cχ * 1 * (cχ * 1) + cχ * 1) * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + ck * 1 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + (ck * 1 * (ck * 1) + ck * 1) * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1))))) + cB * cE) + cD + 42 + 35 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * 1 * (cF + cL * (4 * (cB * cE))) + (cχ * 1 * (cχ * 1) + cχ * 1) * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + ck * 1 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + (ck * 1 * (ck * 1) + ck * 1) * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1)))) + 15 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1)))) + ck * 1 * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1))))) + 240 * (4 * (cB * cE) + 2 * (4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * 1 * (cF + cL * (4 * (cB * cE))) + (cχ * 1 * (cχ * 1) + cχ * 1) * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + ck * 1 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + (ck * 1 * (ck * 1) + ck * 1) * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1))))) + cB * cE)) + (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1)))) + ck * 1 * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1)))) + 15 * (4 * (cB * cE) + 2 * (4 * (8 * (cS + cL * cF + (cL * cL + cL) * (4 * (cB * cE)) + cχ * 1 * (cF + cL * (4 * (cB * cE))) + (cχ * 1 * (cχ * 1) + cχ * 1) * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + ck * 1 * (cF + cL * (4 * (cB * cE)) + cχ * 1 * (4 * (cB * cE) + 2 * (cχ * ((cB + 1) * (cE + 1))))) + (ck * 1 * (ck * 1) + ck * 1) * (4 * (cB * cE) + 2 * (ck * ((cB + 1) * (cE + 1))))) + cB * cE))))))

/-- **`topBound'` is quartic** in `G` given the same graded inputs as `topBound_pb`. -/
theorem topBound'_pb {cN cB cE ck cχ cS cF cL cD : ℕ} {N B E Ck Cχ lk d S₀ F₀ Lr D : V}
    (hN : PB G u cN N 0 0) (hB : PB G u cB B 0 0) (hE : PB G u cE E 1 0) (hCk : PB G u ck Ck 0 0)
    (hCχ : PB G u cχ Cχ 0 0) (hu1 : PB G u 1 (lk + 1) 0 1) (hd1 : PB G u 1 (d + 1) 1 0)
    (hS : PB G u cS S₀ 1 0) (hF : PB G u cF F₀ 1 0) (hL : PB G u cL Lr 0 1) (hD : PB G u cD D 3 0) :
    PB G u (topBc' cN cB cE ck cχ cS cF cL cD) (topBound' N B E Ck Cχ lk d S₀ F₀ Lr D) 4 0 := by
  unfold topBc'
  have h1 : PB G u 1 (1 : V) 0 0 := PB.one'
  have h2 : PB G u 2 (2 : V) 0 0 := PB.two
  ...
  have h1u : PB G u 1 (1 : V) 1 0 := PB.one'.mono hc (e' := 1) (f' := 0) (by norm_num) le_rfl
  have hBE := (hB.mul hE).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)
  have h4BE := (h4.mul hBE).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)
  have hLin := ((((((hN).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)).add hBE).add ((hB).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num))).add hE).add h1u).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)
  have hStepK := PB.of_le (stepK_le N E B) ((h1387.mul hLin).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num))
  have hB1 := (hB.add h1).mono hc (e' := 0) (f' := 0) (by norm_num) (by norm_num)
  have hE1' := (hE.add h1u).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)
  have hQp := PB.of_le (q := kitQ (Cχ : V) B E) (le_of_eq rfl) ((hCχ.mul (hB1.mul hE1')).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num))
  have hQk := PB.of_le (q := kitQ (Ck : V) B E) (le_of_eq rfl) ((hCk.mul (hB1.mul hE1')).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num))
  have hGp := PB.of_le (q := growK B E (kitQ (Cχ : V) B E)) (le_of_eq rfl) ((h4BE.add (h2.mul hQp)).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num))
  have hGk := PB.of_le (q := growK B E (kitQ (Ck : V) B E)) (le_of_eq rfl) ((h4BE.add (h2.mul hQk)).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num))
  have hLp := (hCχ.mul hu1).mono hc (e' := 0) (f' := 1) (by norm_num) (by norm_num)
  have hLk := (hCk.mul hd1).mono hc (e' := 1) (f' := 0) (by norm_num) (by norm_num)
  have hDp := PB.reduce hc (PB.of_le (q := kitD (Cχ : V) lk) (le_of_eq (by unfold kitD; ring)) ((hCχ.mul ((hu1.mul hu1).mul hu1)).mono hc (e' := 0) (f' := 3) (by norm_num) (by norm_num)))
  have hDk := PB.of_le (q := kitD (Ck : V) d) (le_of_eq (by unfold kitD; ring)) ((hCk.mul ((hd1.mul hd1).mul hd1)).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))
  have hLF := (hL.mul hF).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num)
  have hLL := ((hL.mul hL).add ((hL).mono hc (e' := 0) (f' := 2) (by norm_num) (by norm_num))).mono hc (e' := 0) (f' := 2) (by norm_num) (by norm_num)
  have hS1 := PB.of_le (q := topS1 B E S₀ F₀ Lr) (le_of_eq rfl) (((((hS).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num)).add ((hLF).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))).add ((hLL.mul h4BE).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))
  have hF1 := PB.of_le (q := topF1 B E F₀ Lr) (le_of_eq rfl) ((((hF).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num)).add ((hL.mul h4BE).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num))).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num))
  have hLpLp := ((hLp.mul hLp).add ((hLp).mono hc (e' := 0) (f' := 2) (by norm_num) (by norm_num))).mono hc (e' := 0) (f' := 2) (by norm_num) (by norm_num)
  have hS2 := PB.of_le (q := topS2' B E (Cχ : V) lk S₀ F₀ Lr) (le_of_eq rfl) (((hS1.add ((hLp.mul hF1).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))).add ((hLpLp.mul hGp).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num))
  have hF2 := PB.of_le (q := topF2' B E (Cχ : V) lk F₀ Lr) (le_of_eq rfl) ((hF1.add ((hLp.mul hGp).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num))).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num))
  have hS2r := PB.reduce hc ((hS2).mono hc (e' := 1) (f' := 3) (by norm_num) (by norm_num))
  have hLkLk := ((hLk.mul hLk).add ((hLk).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num)
  have hS3 := PB.of_le (q := topS3' B E (Ck : V) (Cχ : V) lk d S₀ F₀ Lr) (le_of_eq rfl) (((((hS2r).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)).add (PB.uG hc ((hLk.mul hF2).mono hc (e' := 2) (f' := 1) (by norm_num) (by norm_num)))).add ((hLkLk.mul hGk).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))
  have hF3 := PB.of_le (q := topF3' B E (Ck : V) (Cχ : V) lk d F₀ Lr) (le_of_eq rfl) (((PB.uG hc hF2).add ((hLk.mul hGk).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))
  have hQ := PB.of_le (q := topQ' B E (Ck : V) (Cχ : V) lk d S₀ F₀ Lr) (le_of_eq rfl) (((h4.mul hS3).add ((hBE).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))
  have hGc := PB.of_le (q := growK B E (topQ' B E (Ck : V) (Cχ : V) lk d S₀ F₀ Lr)) (le_of_eq rfl) ((((h4BE).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)).add (h2.mul hQ)).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))
  have hLeaf := ((((hS3.add ((h15.mul hF3).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).add (h240.mul hGc)).add ((h1).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)))).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num)
  have hRoot := (PB.reduce hc ((hL.mul (((hStepK).mono hc (e' := 1) (f' := 2) (by norm_num) (by norm_num)).add (h36.mul hS1))).mono hc (e' := 1) (f' := 3) (by norm_num) (by norm_num))).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num)
  have hCostP := PB.of_le (costK9_le N E B (kitQ (Cχ : V) B E) (kitD (Cχ : V) lk)) (((((((((h1899.mul hLin).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num)).add ((h27.mul (hQp.mul hE)).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).add ((h2.mul hE).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).add ((h7.mul hQp).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).add ((hDp).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).add ((h42).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num)))).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))
  have hInP := (((PB.of_le (q := ctxB (growK B E (kitQ (Cχ : V) B E)) (topS1 B E S₀ F₀ Lr) (topF1 B E F₀ Lr) ((Cχ : V) * (lk + 1))) (le_of_eq rfl) hS2).mono hc (e' := 2) (f' := 2) (by norm_num) (by norm_num)).add ((hF1.add ((hLp.mul hGp).mono hc (e' := 1) (f' := 1) (by norm_num) (by norm_num))).mono hc (e' := 2) (f' := 2) (by norm_num) (by norm_num))).mono hc (e' := 2) (f' := 2) (by norm_num) (by norm_num)
  have hPin := (PB.reduce hc ((hLp.mul (((hCostP).mono hc (e' := 2) (f' := 2) (by norm_num) (by norm_num)).add (h38.mul hInP))).mono hc (e' := 2) (f' := 3) (by norm_num) (by norm_num))).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num)
  have hCostK := PB.of_le (costK9_le N E B (kitQ (Ck : V) B E) (kitD (Ck : V) d)) (((((((((h1899.mul hLin).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)).add ((h27.mul (hQk.mul hE)).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).add ((h2.mul hE).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).add ((h7.mul hQk).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).add hDk).add ((h42).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))
  have hInK := ((PB.of_le (q := ctxB (growK B E (kitQ (Ck : V) B E)) (topS2' B E (Cχ : V) lk S₀ F₀ Lr) (topF2' B E (Cχ : V) lk F₀ Lr) ((Ck : V) * (d + 1))) (le_of_eq rfl) hS3).add (((PB.uG hc hF2).add ((hLk.mul hGk).mono hc (e' := 2) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)
  have hVer := (hLk.mul (hCostK.add (h38.mul hInK))).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num)
  have hCostC := PB.of_le (costK_le N E B (topQ' B E (Ck : V) (Cχ : V) lk d S₀ F₀ Lr) D) (((((((((h1387.mul hLin).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num)).add ((h27.mul (hQ.mul hE)).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num))).add ((h2.mul hE).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num))).add ((h7.mul hQ).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num))).add ((hD).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num))).add ((h42).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num)))).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num))
  have hInner := (((hS3.add ((h15.mul hF3).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num))).add (h240.mul hGc)).add (((hF3).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)).add ((h15.mul hGc).mono hc (e' := 3) (f' := 0) (by norm_num) (by norm_num)))).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num)
  have hClose := (h15.mul (hCostC.add ((h35.mul hInner).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num)))).mono hc (e' := 4) (f' := 0) (by norm_num) (by norm_num)
  unfold topBound'
  exact (((hLeaf.add hRoot).add hPin).add hVer).add hClose
...
`D ~ topDc`, then `(g + 1)^3 ≤ 8 (g^3 + 1)`. -/
theorem boundedInnerNec_four_of_kit {N B N' B' N₂ B₂ N₃ B₃ Ck : ℕ} {Cχ : Semisentence LAct 1 → ℕ}
    (hpkg : KitPackage' N B N' B' N₂ B₂ N₃ B₃ Ck Cχ) : BoundedInnerNec 4 where
  nec χ := by
    -- the constant is a NATURAL metavariable (`_`): the final `exact` assigns it by unification (a `?_` goal is
    -- synthetic-opaque and would not be)
    exact ⟨_, fun V _ _ k hk ↦ by
      ...
      have hL := PB.of_le h1 (((PB.natCast (q := (12 : V)) 12 (by norm_num)).mul hx).add
        ((PB.natCast (q := (9 : V)) 9 (by norm_num)).mono hc (e' := 0) (f' := 1) le_rfl (by norm_num)))
      have hD := topD_pb N' B' N₂ B₂ N₃ B₃ k (dlen TAct ρ) hlen
      have hmain := topBound'_pb hc (PB.const N) (PB.const B) hE hCk hCχ (PB.u_ hc) hd1 hS hF hL hD
      exact le_trans hbound (PB.final_quart hc hmain)⟩


end final4

/-! ## 12. The kits with a polynomial list length (`BRIEF.md` §11, THE SECOND ACCOUNTING FINDING, 2026-09-15)

The verify list is `O((dlen ρ + 1)³)` long, not `O(dlen ρ)` (the `all`/`exs` prologues re-walk the `qVec`
iterates, `Prologue.lean` §18, `NodeSize.lean`). `VerifyKit'' … m` is `VerifyKit'` with the list-length
multiplier `Ck·(dlen ρ + 1)` replaced by `Ck·(dlen ρ + 1)^m` everywhere it occurs — AND in the cap: a list
whose eigenvariable indices reach `Ck·(dlen ρ + 1)^m` can only be applicable at a cap
`E ≥ Ck·((dlen ρ + 1)^m + i)` (`HornOK` charges `termLen (^&j) = j + 1 ≤ E`), so the cap
`Ck·(dlen ρ + i + 1)` of `VerifyKit'` would make the kit UNSATISFIABLE for `m ≥ 2`. At `m = 1` the two
caps agree (`add_right_comm`) and `VerifyKit'' … 1 ↔ VerifyKit'` (`verifyKit''_one_iff`). -/

section kitsPoly

/-- **`VerifyKit''`** — `VerifyKit'` with the list length `Ck·(dlen ρ + 1)^m` (and the matching cap). -/
structure VerifyKit'' (tbl N B W tblN : V) (Ck : ℕ) (m : ℕ) : Prop where
  ok : ∀ {ρ x Γ i E L : V}, Proof TAct ρ x → RootLayout Γ x i → IsFormulaSet LAct Γ →
    (Ck : V) * ((dlen TAct ρ + 1) ^ m + i) ≤ E → VerifyGraph W tblN ρ L →
    ListOK tbl E ((9 : ℕ) : V) Γ L ∧ NoDrop' L ∧ shiftsV L ≤ (Ck : V) * (dlen TAct ρ + 1) ^ m ∧
    neg LAct (goalFact (^&(i + 1 + shiftsV L)) (bnum (dlen TAct ρ))) ∈ finalCtx Γ L
  cost : ∀ {ρ x Γ i E L : V}, Proof TAct ρ x → RootLayout Γ x i → IsFormulaSet LAct Γ →
    (Ck : V) * ((dlen TAct ρ + 1) ^ m + i) ≤ E → VerifyGraph W tblN ρ L →
    costSum N E Γ L ≤ (Ck : V) * (dlen TAct ρ + 1) ^ m *
      (costK N E B ((9 : ℕ) : V) (kitQ (Ck : V) B E) (kitD (Ck : V) (dlen TAct ρ)) +
        38 * (ctxBoundG (growK B E (kitQ (Ck : V) B E)) Γ ((Ck : V) * (dlen TAct ρ + 1) ^ m) +
          (fvOccS LAct Γ + (Ck : V) * (dlen TAct ρ + 1) ^ m * growK B E (kitQ (Ck : V) B E)))) ∧
    setLen LAct (finalCtx Γ L) ≤ ctxBoundG (growK B E (kitQ (Ck : V) B E)) Γ ((Ck : V) * (dlen TAct ρ + 1) ^ m) ∧
    fvOccS LAct (finalCtx Γ L) ≤ fvOccS LAct Γ + (Ck : V) * (dlen TAct ρ + 1) ^ m * growK B E (kitQ (Ck : V) B E)

/-- At `m = 1` the two kits coincide. -/
theorem verifyKit''_one_iff {tbl N B W tblN : V} {Ck : ℕ} :
    VerifyKit'' tbl N B W tblN Ck 1 ↔ VerifyKit' tbl N B W tblN Ck := by
  constructor
  · rintro ⟨h1, h2⟩
    refine ⟨fun {ρ x Γ i E L} hρ hR hΓ hE hL ↦ ?_, fun {ρ x Γ i E L} hρ hR hΓ hE hL ↦ ?_⟩
    · have := h1 (E := E) hρ hR hΓ (by rw [pow_one, add_right_comm]; exact hE) hL
      simpa [pow_one] using this
    · have := h2 (E := E) hρ hR hΓ (by rw [pow_one, add_right_comm]; exact hE) hL
      simpa [pow_one] using this
  · rintro ⟨h1, h2⟩
    refine ⟨fun {ρ x Γ i E L} hρ hR hΓ hE hL ↦ ?_, fun {ρ x Γ i E L} hρ hR hΓ hE hL ↦ ?_⟩
    · rw [pow_one, add_right_comm] at hE
      simpa [pow_one] using h1 (E := E) hρ hR hΓ hE hL
    · rw [pow_one, add_right_comm] at hE
      simpa [pow_one] using h2 (E := E) hρ hR hΓ hE hL

/-- **The kit package with a polynomial verify list** (`KitPackage'` with `VerifyKit'' … m`). -/
def KitPackage'' (N B N' B' N₂ B₂ N₃ B₃ Ck : ℕ) (Cχ : Semisentence LAct 1 → ℕ) (m : ℕ) : Prop :=
  ∀ (V : Type) [ORingStructure V] [V↓[ℒₒᵣ] ⊧* 𝗜𝚺₁],
    ∃ tbl W tblN tblL tblM : V, TableOK tbl N ∧ TopTable tbl ∧
      (∀ j < len tbl, formulaLen LAct (rowB tbl.[j]) ≤ B) ∧
      formulaLen LAct (Plength : V) ≤ B ∧ formulaLen LAct (Peq : V) ≤ B ∧ formulaLen LAct (Ple : V) ≤ B ∧
      NumTableOK tblN N' B' ∧ LenTableOK tblL N₂ B₂ ∧ MulTableOK tblM N₃ B₃ ∧
      VerifyKit'' tbl N B W tblN Ck m ∧ ∀ χ, PinKit' χ tbl N B (Cχ χ)

end kitsPoly

/-! ## 13. The assembly with `VerifyKit'' … m` -/

section assemblyPoly

/-- The verify kit's cap at offset `π ≤ Cχ(‖k‖+1)`: `Ck·((d + 1)^m + π)`. -/
noncomputable def eVer'' (k d : V) (Ck Cχ : ℕ) (m : ℕ) : V := (Ck : V) * ((d + 1) ^ m + (0 + (Cχ : V) * (‖k‖ + 1)))
/-- The closing block's indices: `js + 4` with `js = π + 1 + σ`, `σ ≤ Ck(d+1)^m`. -/
noncomputable def eJs'' (k d : V) (Ck Cχ : ℕ) (m : ℕ) : V := (Cχ : V) * (‖k‖ + 1) + 1 + (Ck : V) * (d + 1) ^ m + 4

/-- **The witness cap** for `VerifyKit'' … m` (`Etop` with `eVer`/`eJs` replaced). -/
noncomputable def Etop'' (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : V :=
  eWalk χ k + ePin k Cχ + eVer'' k d Ck Cχ m + eJs'' k d Ck Cχ m + eQ χ + eK k + eL k + eB k + eG k + eD d +
  eN5 k + eN4a k + eN4b k

lemma le_Etop''_walk (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eWalk χ k ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add
lemma le_Etop''_pin (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : ePin k Cχ ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_add_self) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add
lemma le_Etop''_ver (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eVer'' k d Ck Cχ m ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_add_self) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add
lemma le_Etop''_js (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eJs'' k d Ck Cχ m ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_add_self) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add
lemma le_Etop''_q (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eQ χ ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_add_self) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add
lemma le_Etop''_k (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eK k ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_add_self) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add
lemma le_Etop''_l (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eL k ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_trans (le_trans (le_trans (le_add_self) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add
lemma le_Etop''_b (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eB k ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_trans (le_trans (le_add_self) le_self_add) le_self_add) le_self_add) le_self_add) le_self_add
lemma le_Etop''_g (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eG k ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_trans (le_add_self) le_self_add) le_self_add) le_self_add) le_self_add
lemma le_Etop''_d (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eD d ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_trans (le_add_self) le_self_add) le_self_add) le_self_add
lemma le_Etop''_n5 (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eN5 k ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_trans (le_add_self) le_self_add) le_self_add
lemma le_Etop''_n4a (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eN4a k ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_trans (le_add_self) le_self_add
lemma le_Etop''_n4b (χ : Semisentence LAct 1) (k d : V) (Ck Cχ : ℕ) (m : ℕ) : eN4b k ≤ Etop'' χ k d Ck Cχ m := by
  unfold Etop''; exact le_add_self

noncomputable def topS3'' (B E Ck Cχ lk d S₀ F₀ Lr : V) (m : ℕ) : V :=
  ctxB (growK B E (kitQ Ck B E)) (topS2' B E Cχ lk S₀ F₀ Lr) (topF2' B E Cχ lk F₀ Lr) (Ck * (d + 1) ^ m)
noncomputable def topF3'' (B E Ck Cχ lk d F₀ Lr : V) (m : ℕ) : V :=
  topF2' B E Cχ lk F₀ Lr + Ck * (d + 1) ^ m * growK B E (kitQ Ck B E)
noncomputable def topQ'' (B E Ck Cχ lk d S₀ F₀ Lr : V) (m : ℕ) : V := 4 * topS3'' B E Ck Cχ lk d S₀ F₀ Lr m + B * E

/-- **The explicit bound** with the verify list `Ck·(d + 1)^m` long. -/
noncomputable def topBound'' (N B E Ck Cχ lk d S₀ F₀ Lr D : V) (m : ℕ) : V :=
  (topS3'' B E Ck Cχ lk d S₀ F₀ Lr m + 15 * topF3'' B E Ck Cχ lk d F₀ Lr m +
      (15 * 15 + 15) * growK B E (topQ'' B E Ck Cχ lk d S₀ F₀ Lr m) + 1) +
  Lr * (stepK N E B + 36 * topS1 B E S₀ F₀ Lr) +
  Cχ * (lk + 1) * (costK N E B ((9 : ℕ) : V) (kitQ Cχ B E) (kitD Cχ lk) +
    38 * (ctxB (growK B E (kitQ Cχ B E)) (topS1 B E S₀ F₀ Lr) (topF1 B E F₀ Lr) (Cχ * (lk + 1)) +
      (topF1 B E F₀ Lr + Cχ * (lk + 1) * growK B E (kitQ Cχ B E)))) +
  Ck * (d + 1) ^ m * (costK N E B ((9 : ℕ) : V) (kitQ Ck B E) (kitD Ck d) +
    38 * (ctxB (growK B E (kitQ Ck B E)) (topS2' B E Cχ lk S₀ F₀ Lr) (topF2' B E Cχ lk F₀ Lr) (Ck * (d + 1) ^ m) +
      (topF2' B E Cχ lk F₀ Lr + Ck * (d + 1) ^ m * growK B E (kitQ Ck B E)))) +
  15 * (costK N E B ((8 : ℕ) : V) (topQ'' B E Ck Cχ lk d S₀ F₀ Lr m) D +
    (3 * ((8 : ℕ) : V) + 11) * ((topS3'' B E Ck Cχ lk d S₀ F₀ Lr m + 15 * topF3'' B E Ck Cχ lk d F₀ Lr m +
      (15 * 15 + 15) * growK B E (topQ'' B E Ck Cχ lk d S₀ F₀ Lr m)) +
      (topF3'' B E Ck Cχ lk d F₀ Lr m + 15 * growK B E (topQ'' B E Ck Cχ lk d S₀ F₀ Lr m))))

theorem top_main'' (χ : Semisentence LAct 1) (m : ℕ) {tbl N B W tblN N' B' tblL N₂ B₂ tblM N₃ B₃ : V} {Ck Cχ : ℕ}
    (htbl : TableOK tbl N) (hT : TopTable tbl) (hB : ∀ j < len tbl, formulaLen LAct (rowB tbl.[j]) ≤ B)
    (hPl : formulaLen LAct (Plength : V) ≤ B) (hPeq : formulaLen LAct (Peq : V) ≤ B) (hPle : formulaLen LAct (Ple : V) ≤ B)
    (htblN : NumTableOK tblN N' B') (htblL : LenTableOK tblL N₂ B₂) (htblM : MulTableOK tblM N₃ B₃)
    (hkit : VerifyKit'' tbl N B W tblN Ck m) (hpin : PinKit' χ tbl N B Cχ)
    {k ρ : V} (hρ : Proof TAct ρ (instB (⌜χ⌝ : V) k)) (hlen : dlen TAct ρ ≤ gBudget k)
    {L : V} (hL : VerifyGraph W tblN ρ L) {E : V} (hE : Etop'' χ k (dlen TAct ρ) Ck Cχ m ≤ E) :
    ∃ e Lr : V, LenDerivable TAct e (instB (⌜Box_g χ⌝ : V) k) ∧
      Lr + 4 ≤ 12 * formulaLen LAct (instB (⌜χ⌝ : V) k) + 13 ∧
      e ≤ topBound'' N B E Ck Cχ ‖k‖ (dlen TAct ρ) (setLen LAct (insert (boxFact (qNum χ) (bnum k)) (∅ : V)))
